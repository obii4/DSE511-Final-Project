...
with open("src/models/results/LG_EI_labels.pkl", 'wb') as f:
...
with open("src/models/results/LSVC_EI_labels.pkl", 'wb') as f:
...
with open("src/models/results/XGB_EI_labels.pkl", 'wb') as f:
...
with open("src/models/results/RF_EI_labels.pkl", 'wb') as f:
...
with open("src/models/results/LG_NS_labels.pkl", 'wb') as f:
    pickle.dump(labels_LG, f)
...
with open("src/models/results/LSVC_NS_labels.pkl", 'wb') as f:
    pickle.dump(labels_LSVC, f)
...
with open("src/models/results/XGB_NS_labels.pkl", 'wb') as f:
    pickle.dump(labels_XGB, f)
...
with open("src/models/results/RF_NS_labels.pkl", 'wb') as f:
    pickle.dump(labels_RF, f)
...
with open("src/models/results/LG_TF_labels.pkl", 'wb') as f:
    pickle.dump(labels_LG, f)
...
with open("src/models/results/LSVC_TF_labels.pkl", 'wb') as f:
    pickle.dump(labels_LSVC, f)
...
with open("src/models/results/XGB_TF_labels.pkl", 'wb') as f:
    pickle.dump(labels_XGB, f)
...
with open("src/models/results/RF_TF_labels.pkl", 'wb') as f:
    pickle.dump(labels_RF, f)
...
with open("src/models/results/LG_JP_labels.pkl", 'wb') as f:
    pickle.dump(labels_LG, f)
...
with open("src/models/results/LSVC_JP_labels.pkl", 'wb') as f:
    pickle.dump(labels_LSVC, f)
...
with open("src/models/results/XGB_JP_labels.pkl", 'wb') as f:
    pickle.dump(labels_XGB, f)
...
with open("src/models/results/RF_JP_labels.pkl", 'wb') as f:
    pickle.dump(labels_RF, f)
